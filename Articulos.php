...
?>
    ...
    <input class="form-control me-2" type="text" placeholder="Buscar artículos" name="search">
    <button class="btn btn-primary" type="submit">Buscar</button>
    &nbsp;
    <button class="btn btn-primary" type="submit">All</button>
    &nbsp;
    <button class="btn btn-primary" type="submit" name="filter" value="Computadoras">Computadoras</button>
    &nbsp;
    <button class="btn btn-primary" type="submit" name="filter" value="Laptops">Laptops</button>
    &nbsp;
    <button class="btn btn-primary" type="submit" name="filter" value="Celulares">Celulares</button>
</form>
     ...
     <footer class="bg-dark text-light py-2">
        <div class="container">
            <div class="row">
                    ...
                    <h3 class="mb-0 text-center">Las mejores articulos ⭐⭐⭐</h3>
...
try {
    ...
    if ($_SERVER["REQUEST_METHOD"] == "GET") {
        if (isset($_GET['search']) && !empty($_GET['search'])) {
            ...
            $filter = $_GET['filter'];
            // Añadimos la condición del filtro a la consulta SQL base
    ...
    // Si hay un filtro seleccionado, bind de parámetro
    if (isset($filter)) {
