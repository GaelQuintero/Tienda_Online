...
?>
    ...
    <input class="form-control me-2" type="text" placeholder="Buscar Laptops" name="search">
     ...
     <footer class="bg-dark text-light py-2">
        <div class="container">
            <div class="row">
                    ...
                    <h3 class="mb-0 text-center">Las mejores laptops ⭐⭐⭐</h3>
    ...
    <div class="row row-cols-1 row-cols-md-2 row-cols-lg-3 g-4">
        ...
        try {
            ...
            $sql = "SELECT * FROM articulos WHERE category = 'Laptops'";
            ...
            if (count($articulos) > 0) {
                ...
                echo 'No se encontraron laptops que coincidan con la búsqueda.';
                echo '</div>';
                echo '</div>';
            }
